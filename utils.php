...
*/
if(!function_exists('toMoneyFormat')){
...
*/
if(!function_exists('createTextInputField')){
...
/**
	display a variable in a <pre> tag
*/
...
/*
	get array containing days in week
*/	
...
/*
	shorten a string in charactors
*/
...
/**
    get timestamp difference in days
...
*****************************************************/
function delete_array_value($array,$del_val){
...
/**
    Download file from a url to a path on server
*****************************************************/
...
convert a file size number from a unit to another
allowed : 'Bytes', 'KB', 'MB', 'GB', 'TB'
...
/**
 * get font-awesome icons in an array
 */
